...
\subsection{Example Application: Selecting Similar Images}
...
%Without adopting any one specific application, we present three query algorithms from \cite{mediascope}, one that helps return images similar to a target, and two that help return a diverse set of images.  
%We also present ways to measure the completeness of each, providing a quantified value of a QoI metric.  
