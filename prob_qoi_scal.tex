...
%\let\thefootnote\relax\footnote{Research was sponsored by the U.S. Army Research Laboratory under the Network Science Collaborative Technology Alliance, Agreement Number W911NF-09-2-0053. }

\let\thefootnote\relax\footnote{This work was presented in part at IEEE Wireless Communications and Networking Conference (WCNC) 2016, April 2016 \cite{qoi_symptotics_wcnc}.}
...
%results
Analysis shows that large tradeoffs exist between network parameters, such as QoI requirements, topology, and network size.  Simulation results also provide evidence that the developed framework can estimate network limits and delays with high accuracy.  Finally, this work also introduces  \emph{scalably feasible QoI regions}, which provide upper bounds on QoI requirements that can be supported for certain network applications.
%takeaway
