...
if plot_exp == 1
    if from_scal_exp == 1
        EXP_DIR = sprintf('/home/grads/str5004/Dropbox/data_files/prob_qoi_scal/num_nodes_%i/image_size_%i/not_cont_traffic/flush_queues/line_net/query_rate_%i/timeliness_%i/mbs_%i/rate_div_%i/run_seed_1/', num_nodes, image_size_kb, exp_tness, exp_tness, max_buffer_size, rate_divisor );
...
LOCAL_DIR = sprintf('./num_nodes_%i/image_size_%i_KB/query_rate_%i/line_net/mbs_%i/rate_div_%i', N, image_size_kb, exp_tness, max_buffer_size, rate_divisor);
