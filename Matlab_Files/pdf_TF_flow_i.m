...
%         pdf_TF(i==i_set,:) = pdf_TF(i==i_set,:) + (1/(N-1))*pdf_TF_ftn( N, i, j, x );
        pdf_TF(i==i_set,:) = pdf_TF(i==i_set,:) + (1/(N-1))*pdf_TF_ftn_2( N, i, j, x );
%         pdf_TF(i==i_set,:) = pdf_TF(i==i_set,:) + (1/(N-1))*pdf_TF_ftn_3( N, i, j, x );
    end
